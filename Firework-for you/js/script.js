...
// 随机文字烟花内容
const randomWords = ["元宵节快乐","健康平安", "心想事成", "成功上岸"];
const wordDotsMap = {};
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    canvasContainer.style.backgroundColor = "#000"; // 设置备用背景颜色
});
...
function whiteOrGold() {
	return Math.random() < 0.8 ? COLOR.Gold : COLOR.White;
}
